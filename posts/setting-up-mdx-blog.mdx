...
Plugins work at **bundle** or **chunk** level and usually work at the end of the bundle generation process. Plugins can also modify how the bundles themselves are created. Check Webpack [loaders](https://webpack.js.org/concepts/plugins/) & how to [configure](https://webpack.js.org/concepts/plugins/#configuration).
